...
@php
    $paths = [
        ...
        'eye' => '<path d="M3 12s3.5-7 9-7 9 7 9 7-3.5 7-9 7-9-7-9-7Z" /><circle cx="12" cy="12" r="2.75" />',
        'edit' => '<path d="M15.5 4.5a2 2 0 0 1 2.83 0l1.17 1.17a2 2 0 0 1 0 2.83L8.5 19.5 4 20.5l1-4.5 10.5-11.5Z" /><path d="M13.5 6.5l3 3" />',
        'trash' => '<path d="M5.5 7.5h13" /><path d="M9.5 7.5V5.5a1.5 1.5 0 0 1 1.5-1.5h2a1.5 1.5 0 0 1 1.5 1.5v2" /><path d="M7 7.5 7.8 19a1.5 1.5 0 0 0 1.5 1.4h5.4a1.5 1.5 0 0 0 1.5-1.4l.8-11.5" /><path d="M10.3 11v6" /><path d="M13.7 11v6" />',
        'warning' => '<path d="M12 3.5 21 19.5H3L12 3.5Z" /><path d="M12 10v4" /><path d="M12 16.8h.01" />',
        'check' => '<path d="m5 13 4 4L19 7" />',
        'star' => '<path d="m12 2 2.9 6.4 7.1.6-5.4 4.7 1.6 7-6.2-3.9-6.2 3.9 1.6-7L2.9 9l7.1-.6L12 2Z" />',
        'chest' => '<rect x="4" y="10" width="16" height="9" rx="1.5" /><path d="M4 10a8 4 0 0 1 16 0" /><path d="M4 14h16" /><rect x="10.5" y="12.5" width="3" height="3" rx="0.5" />',
        'chat' => '<path d="M4 5.5h16a1 1 0 0 1 1 1V15a1 1 0 0 1-1 1H9l-4.5 4V16H4a1 1 0 0 1-1-1V6.5a1 1 0 0 1 1-1Z" />',
        'heart' => '<path d="M12 20s-7-4.35-9.5-8.8C.7 7.9 2.3 4.5 5.8 4.1c2-.23 3.6.8 4.4 2.2a.9.9 0 0 0 1.6 0c.8-1.4 2.4-2.43 4.4-2.2 3.5.4 5.1 3.8 3.3 7.1C19 15.65 12 20 12 20Z" />',
    ];
@endphp
