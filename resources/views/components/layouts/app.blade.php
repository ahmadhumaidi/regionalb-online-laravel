...
<body class="min-h-screen bg-surface-muted font-sans text-ink antialiased" x-data="{ sidebarOpen: false }">
    ...
    <div class="flex min-h-screen">
        ...
        <aside
            class="fixed inset-y-0 left-0 z-40 flex w-72 -translate-x-full transform flex-col border-r border-border transition-transform duration-200 lg:sticky lg:top-0 lg:h-screen lg:translate-x-0 lg:self-start"
