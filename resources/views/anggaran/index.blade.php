<x-layouts.app title="Anggaran & Laporan Iklan" active="anggaran">
    @if (auth()->user()->role === 'koordinator')<div class="mb-4"><a href="{{ route('anggaran.create') }}" class="rounded-lg bg-brand-600 px-4 py-2 text-sm font-semibold text-white">Laporkan Iklan</a></div>@endif
