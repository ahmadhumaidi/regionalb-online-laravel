<x-layouts.app title="Ganti Password" active="password">
    <div class="mx-auto max-w-md rounded-2xl border border-border bg-surface p-6 shadow-sm">
        @if ($errors->any())
        ...
        <form method="POST" action="{{ route('profile.password') }}" class="space-y-4">
            ...
            <div>
                ...
                <input id="old_password" type="password" name="old_password" required
                    class="w-full rounded-lg border border-border bg-surface px-3 py-2.5 text-sm text-ink focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 focus:outline-none">
            </div>
            <div>
