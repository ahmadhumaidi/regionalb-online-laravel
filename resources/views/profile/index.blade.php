        ...
        <div class="grid gap-5 lg:grid-cols-[270px_1fr]">
            <aside class="rounded-2xl border border-white/10 bg-[#212446] p-5 text-center">
                <div class="relative mx-auto h-40 w-40">
                    <div class="league-frame league-frame-{{ strtolower($league) }} h-40 w-40 rounded-2xl p-[3px] shadow-xl">
                        <div class="flex h-full w-full items-center justify-center overflow-hidden rounded-[13px] bg-gradient-to-br from-emerald-400 to-sky-400 text-4xl font-black">
